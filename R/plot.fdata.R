...
#' @param ask Logical. If \code{TRUE}, prompts for user interaction with the current graphics device.
#' @param col  The colors for curves, lines and points.
...
############################################ Auxiliar functions
image_scale <- function(z, zlim, col = heat.colors(12),
