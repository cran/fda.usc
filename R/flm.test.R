...
#'  The type of basis used will be the given by the argument \code{type.basis} and must be one of the class of \code{create.basis}. Further arguments passed to \link[fda]{create.basis} (not \code{rangeval} that is taken as the \code{rangeval} of \code{X.fdata}), can be passed throughout \code{\dots}.
#' }
...
#'   }
#'  Although other basis types supported by \link[fda]{create.basis} are possible, \code{"bspline"} and \code{"fourier"} are recommended. Other basis types may cause incompatibilities.
...
#' @param \dots Further arguments passed to \link[fda]{create.basis}.
#'  
